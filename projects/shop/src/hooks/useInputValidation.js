...
const useInputValidation = (validateValueFunc) => {
    ...
    const inputChangeHandler = (e) => dispatchAction({
        type: "INPUT_CHANGE",
        value: e.target.value
    })
    const inputLostFocusHandler = () => dispatchAction({
        type: "INPUT_BLUR"
    })
    const resetValues = () => dispatchAction({
        type: "INPUT_RESET"
    })
